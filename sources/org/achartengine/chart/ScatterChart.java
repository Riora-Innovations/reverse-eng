        ...
        switch ($SWITCH_TABLE$org$achartengine$chart$PointStyle()[renderer.getPointStyle().ordinal()]) {
            ...
            case 2:
                for (int i2 = 0; i2 < length; i2 += 2) {
                    drawCircle(canvas, paint, ((Float) points.get(i2)).floatValue(), ((Float) points.get(i2 + 1)).floatValue());
                }
                break;
            case 3:
                float[] path = new float[6];
                for (int i3 = 0; i3 < length; i3 += 2) {
                    drawTriangle(canvas, paint, path, ((Float) points.get(i3)).floatValue(), ((Float) points.get(i3 + 1)).floatValue());
                }
                break;
            case 4:
                for (int i4 = 0; i4 < length; i4 += 2) {
                    drawSquare(canvas, paint, ((Float) points.get(i4)).floatValue(), ((Float) points.get(i4 + 1)).floatValue());
                }
                break;
            case 5:
                float[] path2 = new float[8];
                for (int i5 = 0; i5 < length; i5 += 2) {
                    drawDiamond(canvas, paint, path2, ((Float) points.get(i5)).floatValue(), ((Float) points.get(i5 + 1)).floatValue());
                }
                break;
            case 6:
                for (int i6 = 0; i6 < length; i6 += 2) {
                    canvas.drawPoint(((Float) points.get(i6)).floatValue(), ((Float) points.get(i6 + 1)).floatValue(), paint);
                }
                break;
        }
