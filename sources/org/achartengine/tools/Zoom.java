    ...
    public void apply(int zoom_axis) {
        ...
        if (this.mChart instanceof XYChart) {
            ...
            for (int i = 0; i < scales; i++) {
                ...
                if (limits != null) {
                    minX = Math.min(this.mRenderer.getXZoomMax(), limits[1] - limits[0]);
                    minY = Math.min(this.mRenderer.getYZoomMax(), limits[3] - limits[2]);
                } else {
                    minX = this.mRenderer.getXZoomMax();
                    minY = this.mRenderer.getYZoomMax();
                }
