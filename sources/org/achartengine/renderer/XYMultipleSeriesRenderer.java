...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
    ...
    public double getXZoomMax() {
        return this.mXZoomMax;
    }

    public void setXZoomMax(double xZoomMax) {
        this.mXZoomMax = xZoomMax;
    }

    public double getYZoomMax() {
        return this.mYZoomMax;
    }

    public void setYZoomMax(double yZoomMax) {
        this.mYZoomMax = yZoomMax;
    }
