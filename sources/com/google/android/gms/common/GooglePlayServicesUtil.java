...
import com.google.android.gms.internal.C0734ef;
import com.google.android.gms.internal.C0751ek;
...
public final class GooglePlayServicesUtil {
    ...
    /* renamed from: F */
    private static int m419F(int i) {
        if (i == -1) {
            return 2;
        }
        return i;
    ...
    /* renamed from: Z */
    private static byte[] m420Z(String str) {
        try {
    ...
    /* renamed from: a */
    public static Dialog m421a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        Builder message = new Builder(activity).setMessage(m427b(activity, i, i3));
        if (onCancelListener != null) {
            message.setOnCancelListener(onCancelListener);
        }
        C0734ef efVar = new C0734ef(activity, m422a(activity, i, i3), i2);
        String b = m426b(activity, i);
        if (b != null) {
        ...
        switch (i) {
            case 0:
                return null;
            case 1:
                return message.setTitle(C0167R.string.common_google_play_services_install_title).create();
            case 2:
                return message.setTitle(C0167R.string.common_google_play_services_update_title).create();
            case 3:
                return message.setTitle(C0167R.string.common_google_play_services_enable_title).create();
            case 4:
            case 6:
                return message.create();
            case 5:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0167R.string.common_google_play_services_invalid_account_title).create();
            case 7:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0167R.string.common_google_play_services_network_error_title).create();
            case 8:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.create();
            case 9:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0167R.string.common_google_play_services_unsupported_title).create();
            case 10:
    ...
    /* renamed from: a */
    public static Intent m422a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return m418E(i2) ? m432u(context) ? C0751ek.m1903ai(GOOGLE_PLAY_SERVICES_PACKAGE) : C0751ek.m1902ah("com.google.android.apps.bazaar") : C0751ek.m1902ah(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return C0751ek.m1900af(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 12:
                return C0751ek.m1904eh();
            default:
                return null;
        }
    }
    ...
    /* renamed from: a */
    public static boolean m423a(Resources resources) {
        if (resources == null) {
            return false;
        }
        return (C0812fr.m2121eJ() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m428b(resources);
    }

    /* renamed from: a */
    private static byte[] m424a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[][] m425a(byte[][]... bArr) {
        int i = 0;
    ...
    /* renamed from: b */
    public static String m426b(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                return resources.getString(C0167R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0167R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0167R.string.common_google_play_services_enable_button);
            default:
    ...
    /* renamed from: b */
    public static String m427b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                String string = m423a(context.getResources()) ? resources.getString(C0167R.string.common_google_play_services_install_text_tablet) : resources.getString(C0167R.string.common_google_play_services_install_text_phone);
                return m418E(i2) ? string + " (via Bazaar)" : string;
            case 2:
                String string2 = resources.getString(C0167R.string.common_google_play_services_update_text);
                return m418E(i2) ? string2 + " (via Bazaar)" : string2;
            case 3:
                return resources.getString(C0167R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0167R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0167R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0167R.string.common_google_play_services_unsupported_text);
            case 12:
                return resources.getString(C0167R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0167R.string.common_google_play_services_unknown_issue);
        }
    }

    /* renamed from: b */
    private static boolean m428b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return C0812fr.m2123eL() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    /* renamed from: do */
    public static boolean m429do() {
        return f496yS ? f497yT : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        return m421a(errorCode, activity, requestCode, null, -1);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        return m421a(errorCode, activity, requestCode, cancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        Intent a = m422a(context, errorCode, -1);
        if (a == null) {
            return null;
        }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0167R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        try {
            ...
            try {
                byte[] a = m424a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), f489yL);
                if (a == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (m424a(packageInfo, a) == null) {
    ...
    /* renamed from: s */
    public static void m430s(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(context);
        if (isGooglePlayServicesAvailable != 0) {
            Intent a = m422a(context, isGooglePlayServicesAvailable, -1);
    ...
    public static boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        ...
        if (z) {
            C0308b.m499a(errorDialog, cancelListener).show(((FragmentActivity) activity).getSupportFragmentManager(), GMS_ERROR_DIALOG);
        } else if (C0812fr.m2121eJ()) {
    ...
    /* renamed from: t */
    private static void m431t(Context context) {
    ...
    /* renamed from: u */
    private static boolean m432u(Context context) {
        if (f496yS) {
            return f498yU;
        }
        try {
            return m424a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f495yR) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
