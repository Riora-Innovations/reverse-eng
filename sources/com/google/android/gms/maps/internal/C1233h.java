...
public interface C1233h extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.h$a */
    public static abstract class C1234a extends Binder implements C1233h {

        /* renamed from: com.google.android.gms.maps.internal.h$a$a */
        private static class C1235a implements C1233h {

            /* renamed from: ky */
            private IBinder f3276ky;

            C1235a(IBinder iBinder) {
                this.f3276ky = iBinder;
            }
            ...
            public void onMapClick(LatLng point) throws RemoteException {
                ...
                try {
                    ...
                    this.f3276ky.transact(1, obtain, obtain2, 0);
        ...
        /* renamed from: ad */
        public static C1233h m3658ad(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1233h)) ? new C1235a(iBinder) : (C1233h) queryLocalInterface;
        }
