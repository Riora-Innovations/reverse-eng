...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class C1212a extends Binder implements IUiSettingsDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IUiSettingsDelegate$a$a */
        private static class C1213a implements IUiSettingsDelegate {

            /* renamed from: ky */
            private IBinder f3269ky;

            C1213a(IBinder iBinder) {
                this.f3269ky = iBinder;
            }
            ...
            public boolean isCompassEnabled() throws RemoteException {
                ...
                try {
                    ...
                    this.f3269ky.transact(10, obtain, obtain2, 0);
            ...
            public boolean isMyLocationButtonEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3269ky.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isRotateGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3269ky.transact(15, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isScrollGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3269ky.transact(12, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isTiltGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3269ky.transact(14, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isZoomControlsEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3269ky.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isZoomGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3269ky.transact(13, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public void setAllGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setCompassEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setMyLocationButtonEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setRotateGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setScrollGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setTiltGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setZoomControlsEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setZoomGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3269ky.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: am */
        public static IUiSettingsDelegate m3629am(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IUiSettingsDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUiSettingsDelegate)) ? new C1213a(iBinder) : (IUiSettingsDelegate) queryLocalInterface;
        }
