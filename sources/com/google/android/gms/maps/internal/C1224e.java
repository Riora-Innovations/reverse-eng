...
public interface C1224e extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.e$a */
    public static abstract class C1225a extends Binder implements C1224e {

        /* renamed from: com.google.android.gms.maps.internal.e$a$a */
        private static class C1226a implements C1224e {

            /* renamed from: ky */
            private IBinder f3273ky;

            C1226a(IBinder iBinder) {
                this.f3273ky = iBinder;
            }
            ...
            public void onCameraChange(CameraPosition position) throws RemoteException {
                ...
                try {
                    ...
                    this.f3273ky.transact(1, obtain, obtain2, 0);
        ...
        /* renamed from: aa */
        public static C1224e m3651aa(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnCameraChangeListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1224e)) ? new C1226a(iBinder) : (C1224e) queryLocalInterface;
        }
