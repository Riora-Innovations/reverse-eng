...
public class C1102iv implements Creator<C1091a> {
    /* renamed from: a */
    static void m3280a(C1091a aVar, Parcel parcel, int i) {
        int p = C0326b.m621p(parcel);
        Set hB = aVar.mo6145hB();
        if (hB.contains(Integer.valueOf(1))) {
            C0326b.m619c(parcel, 1, aVar.getVersionCode());
        }
        if (hB.contains(Integer.valueOf(2))) {
            C0326b.m619c(parcel, 2, aVar.getLeftImageOffset());
        }
        if (hB.contains(Integer.valueOf(3))) {
            C0326b.m619c(parcel, 3, aVar.getTopImageOffset());
        }
    ...
    public C1091a createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == o) {
            return new C1091a(hashSet, i3, i2, i);
        }
        throw new C0325a("Overread allowed size end=" + o, parcel);
    }

    /* renamed from: bI */
    public C1091a[] newArray(int i) {
        return new C1091a[i];
    }
}
